...
const Payment = () => {
  ...
  return (
      <>
      <div className="min-w-screen md:w-[80%] mx-auto lg:w-[60%] h-[650px] flex items-center justify-center px-5 pb-10 pt-16">
    <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
        <div className="w-full pt-1 pb-5">
            <div className="bg-blue-500 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center animate-spin">
